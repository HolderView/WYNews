...
public class RefreshListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private ProgressBar progressBar;//头布局的进度条
    private int downY;//按下时y轴的偏移量
    private OnRefreshListener onRefreshListener;//需要自定义一个接口
    ...
    private void initFooterView() {
        footerView = View.inflate(getContext(), R.layout.refresh_travels_foot, null);
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.refresh_travels_head, null);
        progressBar = (ProgressBar) headerView.findViewById(R.id.pb_listView_header);
        headerView.measure(0, 0);//系统会帮我们自动测量出headerView的高度
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (firstVisibleItemPosition == 0 && -headerViewHeight < paddingTop) {
                    if (paddingTop > 0 && currentState == DOWN_PULL_REFRESH) {//完全显示了
                        ...
                        refreshHeaderView();
                    }else if (paddingTop<0&&currentState==RELEASE_REFRESH){//没有显示
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (currentState==RELEASE_REFRESH){
                    ...
                    if (onRefreshListener!=null){
                        onRefreshListener.onDownPullRefresh();//调用使用者的监听方法
                    }
    ...
    public void setOnRefreshListener(OnRefreshListener onRefreshListener) {
        Log.d("RefreshListView", "setOnRefreshListener");
