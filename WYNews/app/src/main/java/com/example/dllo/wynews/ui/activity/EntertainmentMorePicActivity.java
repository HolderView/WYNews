 ...
 */
public class EntertainmentMorePicActivity extends AbsBaseActivity {
    ...
    protected void initData() {
        ...
        if (intent!=null){
            String url = intent.getStringExtra("entertainment_more_pic_id");
            first = url.substring(4).replace("|", "/");
            title = intent.getStringExtra("entertainment_more_pic_title");
