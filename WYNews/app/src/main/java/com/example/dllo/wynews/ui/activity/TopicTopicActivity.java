 ...
 */
public class TopicTopicActivity extends AbsBaseActivity implements ObservableScrollView.ScrollViewListener{
    ...
    private CardView cv_activity_topic_topic;
    ...
    protected void initViews() {
        cv_activity_topic_topic=byView(R.id.cv_activity_topic_topic);
    ...
    protected void initData() {
        cv_activity_topic_topic.setVisibility(View.GONE);
...
//                activityAdapter.setDatas(datas);
                ...
                Picasso.with(TopicTopicActivity.this).load(questionDetailsBean.getData().getExpert().getPicurl()).into(iv_activity_topic_question_title);
                Picasso.with(TopicTopicActivity.this).load(questionDetailsBean.getData().getExpert().getHeadpicurl()).into(iv_activity_topic_question_author);
                ...
                vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        observableScrollView.setScrollViewListener(TopicTopicActivity.this);
                    }
                });
